...
public:
	...
	//_NODISCARD constexpr ID3D11Buffer** const all_slots() const
	//{
	//	ID3D11Buffer* const b{ _buffer.buffer() };
	//	ID3D11Buffer* const buffers[D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT]
	//	{ b, b, b, b, b, b, b, b, b, b, b, b, b, b };
	//	return (ID3D11Buffer**)buffers;
	//}
...
//For render_texture and depth buffer we only allow 2d textures? At least i think so looking at dx12
